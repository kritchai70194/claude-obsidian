...
- **Unicorn-expansion roadmap (2026-05-26):** 8-phase plan at `~/.claude/plans/second-brain-jazzy-ullman.md`. Phases 1 + 2 + 3 COMPLETE. Now running Phase 4-8 sequentially.
- **Phase 4 in progress:** GTM / Sales pole (Roberge, Ross, Dunford, Raskin). Counter starts at c-000121. Concept pages planned: Repeatable GTM, Strategic Narrative, Positioning as Strategy.
