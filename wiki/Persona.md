...
2. The **engineer-planner pole** (Carmack, Lamport, Allspaw), distinguished individual engineers whose sustained excellence is built on the discipline of planning before code, formal specification before implementation, and disciplined incident review (no root cause; ask How not Why) as the substrate of organizational learning.
